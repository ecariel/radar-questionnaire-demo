...
export class ScheduleGeneratorService {
  ...
  runScheduler(
    ...
    return Promise.all([this.fetchScheduleYearCoverage()]).then(
      ([assessments]) => {
        const schedule: Task[] = [].reduce((list: Task[], assessment) => {
  ...
  fetchScheduleYearCoverage() {
    return Promise.resolve(DefaultScheduleYearCoverage.toString())
